...
Ein solches Feature war ungefähr 2012 tatsächlich einmal in musdb implementiert. Die Folge waren viele falsche Eingaben, weil zusätzliche Angaben die zum kopierten Datensatz passten, aber nicht zum durch das kopieren Entstandenen, einfach mit kopiert und dann nicht gelöscht wurden. Ein zentrales Ziel bei der Entwicklung von musdb ist es Museen das hochqualitative Erfassen ihrer Bestände einfach zu ermöglichen. Ein vollständiges Kopieren von Datensätzen hat sich dafür unserer Erfahrung nach als kontraproduktiv herausgestellt.
